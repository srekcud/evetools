...
const allNavItems = [
  ...
  { id: 'pve', label: 'PVE', route: '/pve', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
...
// Filtered nav items (visible only)
const navItems = computed(() => allNavItems.filter(item => isModuleVisible(item.id)))
