      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between mb-4">
            ...
            >
              <LoadingSpinner v-if="isAddingCharacter" size="sm" />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              ...
              :key="character.id"
              class="bg-slate-900 rounded-xl p-5 border border-slate-800 hover:border-cyan-500/40 transition-all duration-300 group"
            >
