...
class AdminController extends AbstractController
{
    ...
    public function retryFailedMessages(): JsonResponse
    {
        ...
        try {
            ...
            // Use messenger:consume on the failed transport to reprocess messages
            // --limit=50: process up to 50 messages
            // --time-limit=30: stop after 30 seconds max
            // --no-reset: don't reset container between messages (faster)
