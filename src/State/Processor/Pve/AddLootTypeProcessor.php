...
/**
 * @implements ProcessorInterface<AddTypeInput, LootTypeResource>
 */
class AddLootTypeProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): LootTypeResource
    {
        ...
        $settings->addLootTypeId($data->typeId);
