...
#[ApiResource(
    ...
    operations: [
        new Post(
            ...
            openapi: new Model\Operation(summary: 'Add ammo type to settings', tags: ['Revenue - PVE']),
        ),
        new Delete(
            uriTemplate: '/pve/settings/ammo/{id}',
            provider: AmmoTypeProvider::class,
            processor: RemoveAmmoTypeProcessor::class,
            openapi: new Model\Operation(summary: 'Remove ammo type from settings', tags: ['Revenue - PVE']),
        ),
    ],
