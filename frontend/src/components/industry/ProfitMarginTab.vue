...
import CostSummaryCards from '@/components/industry/profit/CostSummaryCards.vue'
  ...
  <div class="space-y-4">
    ...
    <template v-if="result">
      ...
      <CostSummaryCards
        ...
        :best-sell-revenue="bestSellRevenue"
        :best-unit-price="bestUnitPrice"
        :best-profit="bestProfit"
        :profit-per-run="profitPerRun"
        :best-margin="bestMargin"
        :best-venue-label="bestVenueLabel"
      />

      <!-- SECTION C: Sell Price Comparison Table -->
      <VenueComparisonTable
        v-if="sellRows.length > 0"
        :rows="sellRows"
        :runs="result.runs"
      ...
      <InventionOptionsPanel
        ...
        :selected-decryptor-type-id="selectedDecryptorTypeId"
        :effective-invention-cost="effectiveInventionCost"
        :effective-total-cost="effectiveTotalCost"
        :best-margin="bestMargin"
        @select-decryptor="selectDecryptor"
      />
