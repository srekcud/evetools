...
const emit = defineEmits<{
  close: []
  submit: [payload: { description: string; amount: number; date: string }]
}>()
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              :class="[
                ...
                formErrors.description ? 'border-red-500 focus:border-red-500' : 'border-slate-700 focus:border-amber-500'
              ]"
            />
          ...
          <div>
            ...
            <input
              ...
              :class="[
                'w-full bg-slate-800 border rounded-lg px-4 py-2 text-sm focus:outline-hidden',
                formErrors.amount ? 'border-red-500 focus:border-red-500' : 'border-slate-700 focus:border-amber-500'
              ]"
            />
