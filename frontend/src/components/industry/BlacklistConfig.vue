        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          >
            <input
              ...
              class="w-4 h-4 rounded border-slate-600 bg-slate-800 text-red-500 focus:ring-red-500 focus:ring-offset-slate-900"
            />
      ...
      <div>
        ...
        <div class="relative mb-3">
          <input
            ...
            class="w-full px-4 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500"
        ...
        <div v-if="store.blacklist.items.length > 0" class="space-y-1 max-h-64 overflow-y-auto">
          <div
            v-for="item in store.blacklist.items"
            :key="item.typeId"
            class="flex items-center gap-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700"
          >
            <img
              ...
              @error="onImageError"
            />
            <span class="font-medium text-slate-200 flex-1">{{ item.typeName }}</span>
            <button
              @click="removeItem(item.typeId)"
              class="p-1 hover:bg-slate-700 rounded text-slate-500 hover:text-red-400"
            >
