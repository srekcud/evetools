...
#[ApiResource(
    ...
    operations: [
        new Get(
            ...
            openapi: new Model\Operation(summary: 'List character skills', description: 'Returns industry skills for all characters'),
        ),
        new Post(
            ...
            output: CharacterSkillCollectionResource::class,
            openapi: new Model\Operation(summary: 'Sync skills from ESI', description: 'Syncs industry skills from ESI for all characters'),
        ),
        new Patch(
            ...
            openapi: new Model\Operation(summary: 'Update character skills', description: 'Manually update industry skill levels for a character'),
        ),
    ],
